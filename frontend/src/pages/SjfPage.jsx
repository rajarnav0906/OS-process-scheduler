...
import { Plus, Play, Trash2, Timer, Home, Loader2, AlertCircle, Clock } from "lucide-react";
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await axios.post(
        `${import.meta.env.VITE_BACKEND_URL}/api/schedule/sjf`,
        payload
      );
      setResult(res.data);
      setAnimating(true);
      ...
      <div className="relative z-10 w-full space-y-6 sm:space-y-10 flex-1">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <h1 className="text-xl sm:text-3xl font-bold text-cyan-400 flex items-center gap-2 drop-shadow-md">
            ...
            SJF (Non-Preemptive) Scheduling Visualizer
          </h1>
